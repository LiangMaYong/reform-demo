package com.liangmayong.permissionmanager;
...
import com.liangmayong.permissionmanager.listeners.CustomRequestorDialogListener;
import com.liangmayong.permissionmanager.listeners.OnPermissionRequestorListener;
...
public class PermissionManager {
     ...
     */
    public static void requestPermission(final Activity activity, int requestId, String message,
                                         String[] permissionsNeeded, OnPermissionRequestorListener permissionListener) {
        ...
        if (notHasPermissions) {
            ...
            if (shouldShowRequest) {
                ...
                if (requestorrDialogListener != null) {
                    requestorrDialogListener.showRequestDialog(activity, request.getPermissionsNeeded(),
                            request.getRequestId(), title, request.getMessage(), sureName, cancelName);
                    return;
                }
                ...
                builder.setPositiveButton(sureName, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (Build.VERSION.SDK_INT >= 23) {
                            activity.requestPermissions(request.getPermissionsNeeded(), request.getRequestId());
                        }
                    }
                });
     ...
     */
    public static void config(String title, String sureName, String cancelName,
                              CustomRequestorDialogListener requestorrDialogListener) {
